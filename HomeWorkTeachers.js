...
reader.on("close", () => {
    const [a, opp, b, eq, c] = lines[0].split(" ");
    if (a === "x") opp === "+" ? console.log(Number(c) - Number(b)) : console.log(Number(c) + Number(b));
    if (b === "x") opp === "+" ? console.log(Number(c) - Number(a)) : console.log(Number(c) + Number(a));
    if (c === "x") opp === "+" ? console.log(Number(a) + Number(b)) : console.log(Number(a) - Number(b));
});